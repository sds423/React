...
function basic(det){var image1=document.createElement("img");
	...
	email.href="mailto:salapakadattasaivinay@gmail.com";
...
function careerinfo(edu){
	var heading1=documnt.createElement("h2");
...
function education(edu){
	var heading3=documnt.createElement("h2");
